 ...
 * @{
 *
 * @file       pixracer/board-info/pios_board.h
 * @author     Tau Labs, http://taulabs.org, Copyright (C) 2012-2013
 * @author     dRonin, http://dronin.org Copyright (C) 2015
 * @brief      Board specific defines for Pixracer
...
#ifndef PIXRACER_PIOS_BOARD_H_
#define PIXRACER_PIOS_BOARD_H_
