 ...
 */
#define assumptions1 ( \
((int)CARMANUALCONTROLSETTINGS_NAVIGATION1SETTINGS_DISABLED      == (int)NAVIGATIONDESIRED_NAVIGATIONMODE_DISABLED)       && \
((int)CARMANUALCONTROLSETTINGS_NAVIGATION1SETTINGS_MANUAL      == (int)NAVIGATIONDESIRED_NAVIGATIONMODE_MANUAL)       && \
((int)CARMANUALCONTROLSETTINGS_NAVIGATION1SETTINGS_LINEFOLLOWING      == (int)NAVIGATIONDESIRED_NAVIGATIONMODE_LINEFOLLOWING)  		\
)
...
( (int)CARMANUALCONTROLSETTINGS_DRIVINGMODEPOSITION_NAVIGATION1 == (int) DRIVINGSTATUS_DRIVINGMODE_NAVIGATION1) \
)
...
DONT_BUILD_IF(
		NEQ(NAVIGATIONDESIRED_NAVIGATIONMODE_ROLL, CARMANUALCONTROLSETTINGS_NAVIGATION1SETTINGS_ROLL) ||
...
DONT_BUILD_IF(
		NEQ(NAVIGATIONDESIRED_NAVIGATIONMODE_PITCH, CARMANUALCONTROLSETTINGS_NAVIGATION1SETTINGS_PITCH) ||
...
DONT_BUILD_IF(
		NEQ(NAVIGATIONDESIRED_NAVIGATIONMODE_YAW, CARMANUALCONTROLSETTINGS_NAVIGATION1SETTINGS_YAW) ||
